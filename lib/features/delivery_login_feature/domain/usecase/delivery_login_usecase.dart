...
class DeliveryLoginUsecase
    extends UseCaseWithParam<DeliveryLoginEntity, DeliveryLoginParams> {
  final DeliveryLoginRepo deliveryLoginRepo;

  DeliveryLoginUsecase(this.deliveryLoginRepo);

  @override
  Future<Either<Failure, DeliveryLoginEntity>> execute(
      DeliveryLoginParams params) {
    return deliveryLoginRepo.signIn(
        params.userid, params.password, params.lang);
  }
}
